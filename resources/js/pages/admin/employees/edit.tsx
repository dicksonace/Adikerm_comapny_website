...
export default function EmployeesEdit({
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: employee.name, href: route('admin.employees.edit', employee.id) },
    ];

    const hiredAt = employee.hired_at ? employee.hired_at.slice(0, 10) : '';
    ...
    const { data, setData, post, processing, errors, transform } = useForm({
        ...
        show_on_website: employee.show_on_website ?? false,
    });
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route('admin.employees.update', employee.id), { forceFormData: true });
    };
                ...
                <form onSubmit={submit} className="grid max-w-3xl gap-4">
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="grid gap-2">
                            ...
                            {employee.photo && <img src={employee.photo} alt="" className="mb-2 h-16 w-16 rounded-full object-cover" />}
                            <Input
                                id="photo_file"
                                type="file"
                                accept="image/*"
